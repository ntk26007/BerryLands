...
public class Animal {
	...
	// Inicializa los atributos según la especie
	...
	public int defensa(int frutasEntrantes) {
		...
		return frutasEntrantes; // Sin modificación para otras especies
	}
	...
	public int usarFrutas(int cantidad) {
		if (cantidad > frutasAcumuladas) {
			cantidad = frutasAcumuladas; // No puede usar más de las frutas que tiene
		}
